...
<?php if ( $results['post']->id ) { ?>
	<p><a href="admin.php?action=deleteArticle&amp;articleId=<?php echo $results['post']->id ?>" onclick="return confirm('Delete This Article?')">Delete This Article</a></p>
<?php } ?>
